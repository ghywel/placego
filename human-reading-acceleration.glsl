// human-reading-acceleration.glsl
//
...
// which is kept as the picture; the appended passes draw the acceleration
...
//!WIDTH HOOKED.w 8 /
//!HEIGHT HOOKED.h 8 /
//!DESC [reading] acceleration field (px/interval^2) at 1/8 -- the base's own final pass in diag mode
...
//!WIDTH HOOKED.w
//!HEIGHT HOOKED.h
//!DESC [reading] acceleration painted over the picture: hue = direction, colour = magnitude above the floor

// Gates in px/interval^2: below READ_VIS_LO nothing is drawn, colour
// reaches full saturation at READ_SAT_FULL. The demo's measured values
// for this field.
const float READ_VIS_LO   = 0.12;
const float READ_VIS_HI   = 0.22;
const float READ_SAT_FULL = 0.3;
