...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [prop13] contrast-weighted flow propagation slot2->slot3 (pass 1 of 3) [fused with its B->A twin: one dispatch]
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [prop13] contrast-weighted flow propagation slot2->slot3 (pass 2 of 3) [fused with its B->A twin: one dispatch]
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [prop13] contrast-weighted flow propagation slot2->slot3 (pass 3 of 3) [fused with its B->A twin: one dispatch]
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [prop13] three-way data check slot2->slot3: propagated vs raw vs zero, ties to consensus on texture only [fused with its B->A twin: one dispatch]
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [prop13] contrast-weighted flow propagation slot1->slot2 (pass 1 of 3) [fused with its B->A twin: one dispatch]
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [prop13] contrast-weighted flow propagation slot1->slot2 (pass 2 of 3) [fused with its B->A twin: one dispatch]
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [prop13] contrast-weighted flow propagation slot1->slot2 (pass 3 of 3) [fused with its B->A twin: one dispatch]
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [prop13] three-way data check slot1->slot2: propagated vs raw vs zero, ties to consensus on texture only [fused with its B->A twin: one dispatch]
