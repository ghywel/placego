...
//!HEIGHT HOOKED.h 16 /
//!COMPONENTS 4
//!DESC [quint] coarse flow search slot1->slot2 and slot2->slot1 (1/16 res) [fused: one dispatch]
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [quint] refine flow slot1->slot2 (1/8 res)
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [quint] refine flow slot2->slot1 (1/8 res)
...
//!HEIGHT HOOKED.h 16 /
//!COMPONENTS 4
//!DESC [quint] coarse flow search slot2->slot3 and slot3->slot2 (1/16 res) [fused: one dispatch]
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [quint] refine flow slot2->slot3 (1/8 res)
...
//!HEIGHT HOOKED.h 8 /
//!COMPONENTS 2
//!DESC [quint] refine flow slot3->slot2 (1/8 res)
