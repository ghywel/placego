...
// which is kept as the picture; the appended passes draw the jerk
...
//!WIDTH HOOKED.w 8 /
//!HEIGHT HOOKED.h 8 /
//!DESC [reading] jerk field (px/interval^3) at 1/8 -- the base's own final pass in diag mode
...
//!WIDTH HOOKED.w
//!HEIGHT HOOKED.h
//!DESC [reading] jerk painted over the picture: hue = direction, colour = magnitude above the floor

// Gates in px/interval^3: below READ_VIS_LO nothing is drawn, colour
