...
#
# Point [shader-path] at human-reading-quad.glsl (or any shader with its
# read_view default set above 0 -- see tests/add_human_reading.py) to see the
# field painted over the picture rather than the final image -- the
